...
gfimp = [SpinGfimp(nsites, z_mats.size, V[i, i], beta) for i in range(nimp)]
...
for adjust_mu in adjust_mus:
    ...
    output_folder = f"{temperature_data_folder}/dmft/eta_{eta}/spin/nsites_{nsites}/field_{field}/adjust_mu_{adjust_mu}"
