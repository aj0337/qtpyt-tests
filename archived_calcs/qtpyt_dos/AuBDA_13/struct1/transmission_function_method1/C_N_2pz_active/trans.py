...
np.save("nodes_cutcoupled",nodes)
np.save("hs_list_cutcoupled",(hs_list_ii, hs_list_ij))
de = 0.01
...
for eta in etas:
    ...
    if comm.rank == 0:
        np.save(f'ET_eta{eta}_test.npy', (energies, T))
