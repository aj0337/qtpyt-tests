...
def plot(gf, sigma_func, semilogy=True, reference_gf=None, label_ref="DFT"):
    """Plot the spin-resolved Green's function DOS and Tr(Sigma) with an optional reference DOS."""
...
output_folder = f"output/lowdin/dyson/spin_dmft/beta_38.68/nbaths_{nbaths}/U_matrix"
