#!/bin/bash -l
#SBATCH --no-requeue
#SBATCH --job-name="dmft_nbath_8_adjustmu_False_dc_False"
#SBATCH --nodes=9
...
srun -n 9 python run_dmft.py 8 0.5 False False
srun -n 9 python get_transmission.py 8 0.5 False False
