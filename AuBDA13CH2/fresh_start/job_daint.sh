...
# srun -n 10 python get_dft_dos.py
# srun -n 10 python get_dft_transmission.py
# srun -n 10 python get_active_embedding_hybridization.py
srun -n 1 python run_dmft.py
# srun -n 10 python get_dmft_transmission.py
