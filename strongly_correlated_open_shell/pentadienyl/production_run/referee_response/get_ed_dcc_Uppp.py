...
for U_val in U_list:
    print("\n" + "=" * 72)
    print(f"Running ED double counting for U_onsite = {U_val:.3f} eV")
    print("=" * 72)
    ...
    def residual_function(dc_diag):
        ...
        print(f"[Broyden][U={U_val:.3f}] Residual norm: {residual_norm:.6e}, DC_diag: {dc_diag}")
    ...
    out_name = f"{output_folder}/ed_dc_diag_Uppp_{U_val:.3f}.npy"
