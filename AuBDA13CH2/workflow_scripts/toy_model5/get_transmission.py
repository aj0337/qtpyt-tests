...
energies_folder = "../../output/compute_run/toy_model5"
output_folder = f"../../output/compute_run/toy_model5/nbaths_{nbath}_U_{U}_{'with_dc_correction' if double_counting else 'without_dc_correction'}_{'adjust_mu' if adjust_mu else 'no_adjust_mu'}"
